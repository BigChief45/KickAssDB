...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Apr 23 23:06:48 CST 2014
  */
                ...
                switch ( (int) type) 
                {
                    case 0:
                        ...
                        if ( from_tables.size() > 1 )
                            new_table = Table.mergeTables(from_tables.get(0), from_tables.get(1));
                        else
                            new_table = from_tables.get(0);
