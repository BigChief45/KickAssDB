...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon May 19 15:24:41 CST 2014
  */
                                ...
                                if ( t.getTable_name().toLowerCase().equals(table_name.toString().toLowerCase()) )
                                {
                                    ...
                                    if(val) 
                                    {
                                        ...
                                        if ( t.hasIndexes() )
                                        {
                                            ...
                                            int fieldPosition = 0;
                                            for ( Attribute a : t.getIndexes() )
                                            {
                                                fieldPosition = t.getFieldPosition(a.getAttribute_name());
                                                ...
                                                if ( a.getIndexType() == Attribute.IndexType.TREE_TYPE_INDEXING )
                                                    if ( a.getType() == Attribute.Type.INTEGER)
                                                        a.getBTree().put((int) new_tuple.getValue(fieldPosition).getValue(), new_tuple);
                                                    else if ( a.getType() == Attribute.Type.VARCHAR)
                                                        a.getBTree().put((int) new_tuple.getValue(fieldPosition).getValue().toString().length(), new_tuple);
                                                else if ( a.getIndexType() == Attribute.IndexType.HASH_TYPE_INDEXING )
                                                    if ( a.getType() == Attribute.Type.INTEGER)
                                                        a.getHashTable().put((int) new_tuple.getValue(fieldPosition).getValue(), new_tuple);
                                                    else if ( a.getType() == Attribute.Type.VARCHAR)
