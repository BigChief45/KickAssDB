...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Mar 23 18:46:49 CST 2014
  */
                        ...
                        if ( schema.getTable_count() > 0 )
                        {
                            ...
                            for ( Table t : schema.getSchema() )
                            {
                                if ( t.getTable_name().toLowerCase().equals(table_name.toString().toLowerCase()) )
                                {
                                    ...
                                    val = Validations.validateInsertingTuple(attType, valType) && Validations.validateColumnSize(temp_tuple);  
